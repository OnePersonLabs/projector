...
This is evidence under a trusted-workspace/host assumption. Same-user code or a compromised host can tamper with it. Separate processes, hashes, browser contexts and a nonce do not establish OS confinement, anti-forgery independence or host-network denial. A requirement needing stronger assurance remains open unless an actual supported host capability supplies it; do not silently weaken accepted assurance to mark completion. Oracle independence is reviewed separately from custody.
