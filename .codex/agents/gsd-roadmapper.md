...
Reference full template: `/home/zethj/dev/projector/.codex/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/zethj/dev/projector/.codex/gsd-core/templates/state.md`.
