...
- Usage: Reference from command with `@/home/zethj/dev/projector/.codex/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /home/zethj/dev/projector/.codex/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/zethj/dev/projector/.codex/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
