...
<!-- For checkpoint task examples and patterns, see @/home/zethj/dev/projector/.codex/gsd-core/references/checkpoints.md -->
...
See `/home/zethj/dev/projector/.codex/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/home/zethj/dev/projector/.codex/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/home/zethj/dev/projector/.codex/gsd-core/workflows/verify-phase.md` for verification logic.
