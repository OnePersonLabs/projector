...
- **Global scope**: `/home/zethj/dev/projector/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/zethj/dev/projector/.codex/notes/`)
...
2. Glob `/home/zethj/dev/projector/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/home/zethj/dev/projector/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/zethj/dev/projector/.codex/notes/` — works in any directory
