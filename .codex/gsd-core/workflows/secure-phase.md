...
```
Agent(
  prompt="Read /home/zethj/dev/projector/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/zethj/dev/projector/.codex/gsd-core/templates/SECURITY.md`
