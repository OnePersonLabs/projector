...
```markdown
Read /home/zethj/dev/projector/.codex/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/zethj/dev/projector/.codex/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/zethj/dev/projector/.codex/agents/gsd-ui-checker.md for instructions.
...
@/home/zethj/dev/projector/.codex/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /home/zethj/dev/projector/.codex.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/home/zethj/dev/projector/.codex/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/home/zethj/dev/projector/.codex/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
