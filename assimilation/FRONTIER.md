...
The proposed `$projector-assimilate` skill has a short entrypoint and conditional workspace/change references. Three bounded trials exposed and repaired source-ID leakage, then confirmed that a weak proposal can stop before change handoff. The [skill review](reviews/projector-assimilate-review.md) records the remaining scale risk. All 56 captured turn units and 15 attachment hashes now have review dispositions, with unrecoverable upstream limits stated in [intake coverage](intake/reviews/coverage-gaps.md). An independent source-severed cold read recovered the four critical boundaries without needing intake.

The user has settled two apparent conflicts: cost-conscious routing never silently lowers required competence when quota is low, and assimilation's topic notes remain separate from Projector's accepted concepts even when they discuss those concepts. No further clarification is needed for the current source-reconciliation step.
