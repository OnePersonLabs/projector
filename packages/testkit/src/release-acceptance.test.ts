...
import { hashFramedDomain, hydrateCanonicalDocumentWire } from "@projector/core";
...
import { compileReleaseEvidence, deriveAcceptanceInventory, evaluateIndependentConformance, PACKED_LIFECYCLE_OBLIGATION_IDS, traceabilityEntryHash, traceabilityInventoryHash, validateTraceabilityTestReferences, verifyTraceabilityAssertionIdentity, verifyTraceabilityManifest, type AcceptanceSource, type TraceabilityManifest } from "./release-acceptance.js";
...
describe("public release acceptance authority", { timeout: 30_000 }, () => {
  ...
  it("independently interprets raw authored-wire TOML and catches a shared seeded semantic contradiction", () => {
    ...
    const semanticHash = hydrateCanonicalDocumentWire(conceptWire(id)).semanticHash;
