...
2. Read [proposal-schema.md](proposal-schema.md). Write one strict proposal JSON file using the retrieved meaning, repository evidence, and the user's request. Preserve existing requirement/scenario keys where they own the meaning. The proposal is interpretation evidence, not authority.
