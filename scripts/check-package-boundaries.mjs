...
async function main() {
  ...
  const errors = [
    ...
    ...validateCuratedExports(controlPlaneFacade, [
      ...
      "KnowledgeApplicationEvidenceAssessment",
      ...
      "RepresentationProfileReconciliationOutput",
